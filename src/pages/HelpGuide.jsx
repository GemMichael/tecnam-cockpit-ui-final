        ...
        <div className="space-y-6">
          ...
          <GlassCard className="p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-500">
              Send your question for instructor or system-support review.
            </p>
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <option value="cockpit-inspection">
                    Cockpit Inspection
                  </option>

                  <option value="engine-starting">
                    Engine Starting
                  </option>

                  <option value="before-taxi">
                    Before Taxi
                  </option>
                  ...
                  <option value="before-takeoff">
                    Before Takeoff
                  </option>

                  <option value="after-landing">
                    After Landing
                  </option>
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 py-3.5 text-sm font-semibold text-white shadow-lg shadow-blue-600/20 transition hover:bg-blue-700"
              >
              ...
              {sent && (
                ...
                <div className="rounded-xl border border-emerald-100 bg-emerald-50 p-3 text-sm font-semibold text-emerald-700">
                  ✓ Demo inquiry submitted successfully.
                </div>
            ...
            <p className="mt-4 text-[10px] leading-5 text-slate-400">
              This inquiry form is currently a local demonstration. It can later be connected to FastAPI and SQLite without adding AI.
            </p>
